...
public class RedisKey {
    ...
    public static final String REGISTER_CODE_SEND_TIMES = "user.register.code.send.times.%s"; //注册验证码发送次数
    public static final String REGISTER_CODE_FAIL_TIMES = "user.register.code.fail.times.%s"; //注册验证码验证失败次数
